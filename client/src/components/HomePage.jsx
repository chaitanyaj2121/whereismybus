  ...
  useEffect(() => {
    const fetchAllStops = async () => {
      try {
        ...
        console.error("Error fetching all stops:", error) // Optionally, show an error message to the user, e.g., using a state variable
      }
    }
  ...
  const handleSearch = async (e) => {
    ...
    try {
        ...
        if (route.stops && Array.isArray(route.stops)) {
          ...
          if (fromIndex !== -1 && toIndex !== -1 && fromIndex < toIndex) {
            ...
            matchingRoutes.push({
              ...
              stops: route.stops,
              createdBy: route.createdBy, // HERE'S THE CHANGE: Use route.routeStartTime instead of a static value
      ...
      if (matchingRoutes.length > 0) {
        ...
        console.log("Navigating to /searchResults with routes:", matchingRoutes) // If buses are found, navigate to SearchResultsPage
